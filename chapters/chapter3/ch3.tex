...
\bigskip
\LEnote{*** INSERIRE GAUGE INVARIANCE IN FORMA DI TEOREMA ***}
...
\LEnote{*** dimostrazione semplice corrente ``leyla'' = corrente di calore, mentre quella ``di carbogno'' è sbagliata ***}
