...
\begin{itemize}
    ...
    \item[\textbf{\cite{Ercole2016}}] \citeauthor*{Ercole2016}, Gauge invariance
of thermal transport coefficients. \emph{J. Low Temp. Phys.}, 185:79–86, 2016. \\ 
    \item[\textbf{\cite{Ercole2017}}] \citeauthor*{Ercole2017}, Accurate thermal conductivities
from optimally short molecular dynamics simulations. \emph{Sci. Rep.}, 7:15835, 2017. \\
    \item[\textbf{\cite{Baroni2018}}] \citeauthor*{Baroni2018}, Heat Transport in Insulators from Ab Initio Green-Kubo Theory. In \emph{Handbook of Materials Modeling: Applications: Current and Emerging Materials}, p. 1--36, edited by Andreoni and Yip, Springer,  2018. \\
    \item[\textbf{\cite{Bertossa2018}}] \citeauthor*{Bertossa2018}, Transport coefficients in multi-component fluids from equilibrium molecular dynamics. \emph{arXiv}:1808.03341, 2018. \\
\end{itemize}
