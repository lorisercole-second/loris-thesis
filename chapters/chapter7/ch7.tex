...
As a plus, this principle also offers us some freedom in the definition of the energy flux, enabling one to choose an expression that can optimize its statistical properties without affecting the computed value of thermal conductivity. \LE{We presented this idea and applied it to molecular fluids and solids, where it is possible to identify non-diffusive fluxes that do not contribute to $\kappa$ and can be removed by some decorrelation techniques.}
