...
A generalised central-limit theorem for Fourier transforms of stationary time series ensures that, in the large-$N$ limit, these coefficients are a set of independent (almost) identically distributed zero-mean normal deviates \citep{Anderson1994,Peligrad2010}. It follows that:
\begin{align}
...
In order to illustrate the origin of this phenomenon, we consider the case of liquid heavy water that was simulated by \citet{Marcolongo2016} from first-principles. 

\paragraph{Formation energies contributions in heavy water simulations}
\citet{Marcolongo2016} computed the thermal conductivity of heavy water at $400\un{K}$, a temperature that is know to predict qualitatively the self-diffusion coefficient of water at ambient conditions \citep{Sit-Marzari} using the PBE exchange-correlation energy functional \citep{Perdew1996}. 
