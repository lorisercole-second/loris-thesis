...
\end{equation}
for $k \notin \{ 0,\frac{N}{2} \}$. 
\LEnote{***FOOTNOTE COMMENT SU MEDIE DI SPETTRI vs MEDIE DI KAPPA***}
...
\subsection{Data analysis work-flow (solids and one-component fluids)}
...
\LEnote{******* TENERE/TOGLIERE/METTERE IN APPENDICE?? *********}\\
