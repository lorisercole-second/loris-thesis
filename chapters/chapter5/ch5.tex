...
\begin{figure}[!tb]
    \begin{center}
        \subfigure[\label{fig:acf-examples}]{\LE{****************ESEMPI ARGON - ACQUA - SILICA - MGO ***********}} %{\includegraphics[width=10cm]{chapters/chapter5/figures/handbook_argon_egauge_acf.pdf}}
        \subfigure[\label{fig:kappa-examples}]{\LE{****************ESEMPI ARGON - ACQUA - SILICA - MGO ***********}} %{\includegraphics[width=10cm]{chapters/chapter5/figures/handbook_argon_egauge_kappa.pdf}}
    \end{center}
