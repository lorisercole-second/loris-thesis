...
\LEnote{**VA BENE IL TITOLO? OPPURE Density dependence of $\kappa$ **}\\
...
\subsection{Temperature dependence of $\kappa$}  \label{sec:results-quantum-results}

\begin{itemize}
    \item TEMPERATURE DEPENDENCE: experimental values (con spiegazione incertezza misure per fenomeno radiativo)
    \item TEMPERATURE DEPENDENCE: classical and quantum results
    \item problemi di analisi difficile...
