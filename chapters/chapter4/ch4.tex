...
\LEnote{** FORSE ESSENDO CORTO SI PUO' UNIRE A CAP. 3 **}
\begin{LEtext}
...
\LEnote{** FARLA DIVENTARE UN'INTRO GENERALE AI METODI E SPOSTARLA IN CAP. 1 **}
...
\LEnote{** FORSE CITARE ALTRI METODI VIBRAZIONALI: loconi-cosoni...**}
...
\end{LEtext}
\LEnote{** $\mathbf{J}^{el}$ E' NON DIFFUSIVA SOLO IN 1-COMPONENT SYSTEMS?? IN UN FLUIDO MULTI-COMPONENTE MI SEMBRA DIFFUSIVA ***}
