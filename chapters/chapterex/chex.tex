...
\begin{figure}
\begin{center}
\subfigure[\label{f8a}]{\includegraphics[angle=90,width=7cm,height=7cm,angle=-90]{chapters/chapterex/figures/Histogram.eps}}
\subfigure[\label{f8b}]{\includegraphics[angle=90,width=7cm,height=7cm,angle=-90]{chapters/chapterex/figures/Histogram.eps}}
\end{center}
