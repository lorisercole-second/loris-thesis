...
%\usepackage[backend=biber,style=numeric-comp,sorting=none]{biblatex}  % bibliography
...
%\usepackage{hyperref}
\usepackage[inner,right]{showlabels} % uncomment color if you comment this
...
\title{ab initio Green-Kubo Simulations of Silica Glass\\
%{\Large(Sottotitolo)}
}
\author{Loris Ercole}
...
\include{chapters/chapter6/ch6}  % Silica
\include{chapters/chapter7/ch7}  % Conclusions

\appendix
\include{chapters/appendix/appendix}   % Appendix
